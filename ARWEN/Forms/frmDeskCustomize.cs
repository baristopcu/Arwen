...
namespace ARWEN
{
    public partial class frmDeskCustomize : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmDeskCustomize()
        {
            ...
            dtProducts.Columns.Add("EditAmount", typeof (int));
        }
            ...
            if (orderType == "New")
            {
                ...
                using (RestaurantContext dbContext = new RestaurantContext())
                {
                    ...
                    var addProduct = dbContext.Get_All_Products()
                        ...
                        .Select(y => new {Ad = y.ProductName, Fiyat = y.Price, Id = y.ProductID})
                        .ToList();
                    ...
                    dtProducts.Rows.Add(products.ProductID, Adet, products.ProductName, products.Price);
